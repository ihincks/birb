...
transformed data {
  ...
  real A_num;                              // Number of effective shots of A                  
...
parameters {
  ...
  real<lower=0,upper=1> A_unif;            // RB nuisance #1 error
...
model {
  ...
  // this translates to the prior p,A,B iid from unif(0,1)
